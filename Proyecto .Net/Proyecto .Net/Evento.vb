...
Public Class Evento
    ...
    Public Sub ConsEMP()
        ...
        cn.Close()
    End Sub
    Private Sub Evento_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: esta línea de código carga datos en la tabla 'LIVESHOWSGROUPDataSet10.EVENTO' Puede moverla o quitarla según sea necesario.
        Me.EVENTOTableAdapter1.Fill(Me.LIVESHOWSGROUPDataSet10.EVENTO)
        ConsEMP()
        txt_ID.Text = ""
        txt_NOM.Text = ""
    End Sub
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Try
            Dim adaptador As New SqlCommand("INSERT INTO EVENTO VALUES (" & txt_ID.Text & ",'" & txt_NOM.Text & "')", cn)
            cn.Open()
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        cn.ConnectionString = conexion
        Try
            Dim adaptador As New SqlCommand("UPDATE EVENTO SET NOM_EVE ='" & txt_NOM.Text & "' WHERE ID_EVE= " & txt_ID.Text & "", cn)
            cn.Open()
            adaptador.ExecuteNonQuery()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        cn.Open()
        Try
            Dim adaptador As New SqlCommand("DELETE FROM EVENTO WHERE ID_EVE =" & txt_ID.Text & "", cn)
            adaptador.ExecuteNonQuery()
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim adaptador As New SqlDataAdapter("Select * from EVENTO where ID_EVE = " & b.Text & "", cn)

        Dim ds As New DataSet
        adaptador.Fill(ds, "EVENTO")

        If ds.Tables("EVENTO").Rows.Count > 0 Then
            txt_ID.Text = ds.Tables("EVENTO").Rows(0).Item(0).ToString
            txt_NOM.Text = ds.Tables("EVENTO").Rows(0).Item(1).ToString
        Else
